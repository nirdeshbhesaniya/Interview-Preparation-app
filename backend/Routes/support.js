...
router.post('/contact', async (req, res) => {
  try {
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #fff; padding: 30px; border-radius: 0 0 8px 8px; border: 1px solid #ddd;">
              ...
              <p style="color: #555; line-height: 1.6;">
                Thank you for contacting Interview AI support! We have received your message and will get back to you as soon as possible.
              </p>
            ...
            priority === 'high' ? 'We aim to respond to high priority requests within 8 hours.' :
              ...
              <p style="color: #555; line-height: 1.6;">
                Best regards,<br>
                <strong>The Interview AI Team</strong>
              </p>
            </div>
    ...
    if (!autoReplyResponse.ok) {
      console.error('Auto-reply failed, but support email was sent');
    }
